...
function Card ({ title, image, isClicked = 'false', onClick}) {
    ...
    return (
        <div className={isClicked ? 'flex flex-col isClicked max-w-sm rounded shadow-lg' : 'flex flex-col max-w-sm rounded overflow-hidden shadow-lg'} onClick={(e) => onClick(e)}>
